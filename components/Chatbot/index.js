...
const Chatbot = () => {
  ...
  const steps = [
...

    {
      id: 'Icon4Details',
      message:
        'The Meeting Calendar icon streamlines your scheduling and planning tasks. With this, you can effortlessly organize and manage your professional meetings. Schedule meetings, set reminders, and coordinate with your connections efficiently. ',
      trigger: 'NavIcons',
    },
...

    {
      id: 'Icon6Details',
      message:
        'The Export CSV feature empowers users to extract and download data of the User profile in  CSV format. Click on the Export CSV icon to generate a downloadable file containing relevant data, such as contacts, messages, or other selected information. ',
      trigger: 'NavIcons',
    },

    {
      id: 'Icon7Details',
      message:
        'Click on the Notifications icon to access a summary of recent activities, keeping you in the loop and allowing you to respond promptly to new opportunities and interactions. Receive real-time updates about new connection requests, messages, profile views, and other important info and offers from skoop, ',
      trigger: 'NavIcons',
    },

    {
      ...
      options: [
        {
          value: 'RecordingVideoAudio',
          label: 'Recording Video/Audio',
          trigger: 'RecordingVideoAudioDetails',
        },
        {
          value: 'ChatWindow',
          label: 'Chat Window',
          trigger: 'ChatWindowDetails',
        },
        {
          value: 'ContactInfo',
          label: 'Contact Info',
          trigger: 'ContactInfoCardDetails',
        },
        { value: 'BackToStart', label: 'Back to Start', trigger: 'MainMenu' },
      ],
    },
