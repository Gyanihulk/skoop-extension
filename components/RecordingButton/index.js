            ...
            {!isRecordStart && (
              <div class="col-auto">
                <div className="d-flex flex-column align-items-center">
                  <div className="d-flex flex-column" variant="outlined" color={capturing ? 'secondary' : 'primary'} onClick={(e) => startVideoCapture(false, e)} size="small" disabled={isUploading} title="Record Video" id="skoop_record_button">
                    <span class="icon">
                      {capturing ? (
