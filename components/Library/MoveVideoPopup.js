                    ...
                    (folder, index) =>
                      index % 2 === 0 && (
                        <div key={folder.directory_name} className="d-flex">
                          <button className="list-group-item list-group-item-action mr-2" onClick={() => handleMove(folder.directory_name)}>
                            {folder.directory_name}
                          </button>
                          {index + 1 < folders.length && (
                            <button className="list-group-item list-group-item-action" onClick={() => handleMove(folders[index + 1].directory_name)}>
