    ...
    <div>
      ...
      <div className="container d-flex flex-column">
        ...
        <div className="form-group">
          <select
            className={`form-control custom-input-box select-box ${inquiry_type != 'select' ? 'active' : ''}`}
            id="inquiry_type"
            name="inquiry_type"
            value={inquiry_type}
            onChange={(e) => setInquiryType(e.target.value)}
          >
            <option value="select" disabled>Select the Inquery Type</option>
        ...
        <ThankYou heading="Form Submitted" pageToRedirect="Home" redirectPageText="Home" >
          <p>Thank you for reaching out to the Skoop team. We have received your message and will get back to you as soon as possible.
           Your inquiry is important to us, and we are committed to providing you with the assistance you need.</p>
        </ThankYou>
      )}
    </div>
  )
