    ...
    {!showThankyouPage ? (<div>
      ...
      <div className="container d-flex flex-column">
        ...
        <ThankYou heading="Form Submitted" pageToRedirect="Home" redirectPageText="Home" >
          <p>Thank you for submitting the bug report. We appreciate your effort in helping us improve our services.
           Our team will investigate the issue and take the necessary steps to resolve it. We will keep you updated on our progress.</p>
        </ThankYou>
      )}
    </>
  )
