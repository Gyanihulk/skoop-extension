                ...
                <div className="row">
                    ...
                    <div className="card-body cardbody-color p-lg-5">
                            <form
                                ...
                                style={{ paddingTop: '80px', fontFamily: "'Lato', sans-serif"}}
                            >
                                <h2 className="text-center text-dark " style={{ fontWeight: '600'}}>Welcome to Skoop!</h2>
                                <p className="text-center form-text " style={{ color: "rgba(44, 45, 46, 0.5)",fontSize: "14px"}} >It’s time to get more clients and connect again with old connections</p>
                                ...
                                <div className="text-center">
                                    <button type="submit" className="btn btn-primary btn-lg mt-3 mb-2 w-100"
                                        style={{ backgroundColor: '#2D68C4', fontSize: '16px', fontWeight: '600' }}>
                                        Submit
                                    </button>
                                </div>
                            </form>
                                ...
                                >
                                By clicking submit you are agreeing to <span class="footer-font">privacy policies</span> & <span class="footer-font">Terms of use</span>
                                </div>
